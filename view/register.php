<main>
   ...
   <app-authentication>
      <div class="col s9 rght-cntnt">
         <router-outlet></router-outlet>
         <app-signup>
            <div class="authntctn-cntr signup">
               <div class="register-page container">
                  <!---->
                  <div class="row">
                     <div class="col s12">
                        <app-static-inner-content contentcode="signupTop">
                           <div extroutelink="" id="signupTop">
                                    ...
                                    <div>
                                       <div class="splide splide--loop splide--ltr splide--draggable is-active" id="splide01" style="visibility: visible;">
                                          ...
                                          <div class="splide__track" id="splide01-track">
                                             <!---->
                                             <ul class="splide__list" id="splide01-list" style="transform: translateX(1252px);"></ul>
                                          </div>
                                          <div></div>
                              ...
                              <section class="bar-custom">
                                 <div class="container-fluid">
                                    <div class="bar-custom-inner">
                                       <div class="bar-custom-item v1">
                                          <div class="bar-custom-title">7 GÜN 24 SAAT</div>
                                          <div class="live-support-custom">
                                             <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M2.9568 60.9408C2.9568 62.9248 3.7248 64 4.8768 64C5.76544 63.9153 6.59533 63.5185 7.2192 62.88L22.2784 49.6512H47.2832C50.9326 49.6512 54.4325 48.2015 57.013 45.621C59.5935 43.0405 61.0432 39.5406 61.0432 35.8912V13.76C61.0432 10.1106 59.5935 6.61071 57.013 4.03021C54.4325 1.44971 50.9326 0 47.2832 0L16.7168 0C13.0674 0 9.56751 1.44971 6.98701 4.03021C4.40651 6.61071 2.9568 10.1106 2.9568 13.76V60.9408ZM6.7968 13.76C6.80019 11.1301 7.84641 8.60887 9.70604 6.74924C11.5657 4.88961 14.0869 3.84339 16.7168 3.84H47.2832C49.9131 3.84339 52.4343 4.88961 54.2939 6.74924C56.1536 8.60887 57.1998 11.1301 57.2032 13.76V35.8912C57.1998 38.5211 56.1536 41.0423 54.2939 42.902C52.4343 44.7616 49.9131 45.8078 47.2832 45.8112H20.832L19.744 46.7648L6.7968 58.1504V13.76V13.76Z" fill="white"></path>
                                             </svg>
                                             <span>CANLI DESTEK</span>
                                          </div>
                                       </div>
                                       <div class="bar-custom-item v1">
                                          <div class="bar-custom-title">GÜVENİLİR ALTYAPI</div>
                                          <figure class="bar-custom-figure">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-1.png" loading="lazy" alt="">
                                          </figure>
                                       </div>
                                       <div class="bar-custom-item v2">
                                          <div class="bar-custom-title">EN HIZLI YATIRIM VE ÇEKİM OLANAKLARI</div>
                                          <figure class="bar-custom-figure">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-2.png" loading="lazy" alt="">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-3.png" loading="lazy" alt="">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-4.png" loading="lazy" alt="">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-5.png" loading="lazy" alt="">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-6.png" loading="lazy" alt="">
                                             <img src="https://v3.pronetstatic.com/perabet/upload_files/pera-logo-7.png" loading="lazy" alt="">
                                          </figure>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <div>
                              <style type="text/css">
                                 ...
                                 .bar-custom .bar-custom-item + .bar-item {
                  ...
                  <div class="row signup-cntr">
                     ...
                     <div class="col s12">
                        ...
                        <!---->
                        <form novalidate="" autocomplete="on" class="ng-untouched ng-pristine ng-valid">
                           <div ngmodelgroup="signUpFields" class="row ng-untouched ng-pristine ng-invalid">
                              <!---->
                              <div class="col prsnl-infrmtn s4">
                                 <div class="modul-accordion">
                                    ...
                                    <div class="module-content">
                                       <!----><!---->
                                       <div class="input-field username required">
                                          ...
                                          <div class="cpf-number-loading">
                                             <input debounce="2000" class="validate browser-default place-text ng-untouched ng-pristine ng-invalid" id="username" placeholder="" type="text" required=""><!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                          </div>
                                          <!----><!----><!----><!---->
                                       </div>
                                       <!----><!----><!----><!----><!----><!----><!----><!---->
                                       <div ng-class="{field.name}" class="input-group align-items-res firstName flex-container">
                                          <div class="input-field required">
                                             <span class="field-label required">Ad</span><!----><input type="text" class="validate browser-default place-text ng-untouched ng-pristine ng-invalid" id="firstName" placeholder="" required=""><!---->
                                          </div>
                                       ...
                                       <!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                       <div class="input-field surname required">
                                          ...
                                          <!----><!---->
                                          <div class="cpf-number-loading">
                                             <input debounce="2000" class="validate browser-default place-text ng-untouched ng-pristine ng-invalid" id="surname" placeholder="" type="text" required=""><!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                          </div>
                                          <!----><!----><!----><!---->
                                       </div>
                                       <!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                       <div class="input-field email required">
                                          ...
                                          <!----><!---->
                                          <div class="cpf-number-loading">
                                             <!----><!----><!----><input debounce="500" class="validate browser-default place-text ng-untouched ng-pristine ng-invalid" id="email" placeholder="" type="email" required="" maxlength="100" pattern="^\s*(([^<>()\[\]\\,`~;:$%^*#№\s@&quot;]{2,})|(&quot;.+&quot;))@(([a-zA-Z0-9^(-?)]+\.)+[a-zA-Z]{2,})\s*$"><!----><!----><!----><!----><!----><!---->
                                          </div>
                                          <!----><!----><!----><!---->
                                       </div>
                                       <!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                       <div class="input-field phone required">
                                          ...
                                          <div>
                                             <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                                ...
                                                <input type="text" ng2telinput="" class="browser-default ng-untouched ng-pristine ng-invalid" id="phone" placeholder="501 234 56 78" data-intl-tel-input-id="0" required="" style="padding-left: 85px;">
                                             </div>
                                             <!----><!---->
                                          </div>
                                          <!----><!---->
                              ...
                              <div class="col prsnl-infrmtn s4">
                                 <div class="modul-accordion">
                                    ...
                                    <div class="module-content">
                                       <!----><!---->
                                       <div class="input-field password bubble required">
                                          ...
                                          <!----><!---->
                                          <div class="cpf-number-loading">
                                             <input debounce="2000" class="validate browser-default place-text ng-untouched ng-pristine ng-invalid" id="password" placeholder="" type="password" required="" maxlength="25"><!----><!----><!----><!----><!----><!---->
                                             <bubble-validator>
                                       ...
                                       <!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                       <div class="input-field safeWord">
                                          ...
                                          <!----><!---->
                                          <div class="cpf-number-loading">
                                             <input debounce="2000" class="validate browser-default place-text ng-untouched ng-pristine ng-valid" id="safeWord" placeholder="(opsiyonel)" type="text"><!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                          </div>
                                          <!----><!----><!----><!---->
                                       </div>
                                       <!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
                                       <div class="select-field required" style="position: relative;">
                                          <!---->
                                       </div>
                                       <!---->
                                       <div class="select-field required">
                                          ...
                                          <div>
                                             <select class="browser-default ng-untouched ng-pristine ng-valid" id="currencyId" required="" style="flex: 3 1 0%;">
                                       ...
                                       <!----><!----><!----><!----><!----><!----><!---->
                                       <div class="input-field birthdate required">
                                          <span class="field-label required">Doğum Tarihi</span><!---->
                                          <birthdate-input>
                        <form novalidate="" class="ng-untouched ng-pristine ng-invalid"><div class="flex-container"><div class="flex-item"><div class="select-field"><select id="days" class="browser-default ng-untouched ng-pristine ng-invalid"><option selected="" value="" disabled="">Gün</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><!----></select></div></div><div class="flex-item"><div class="select-field"><select id="months" class="browser-default ng-untouched ng-pristine ng-invalid"><option selected="" value="" disabled="">Ay</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><!----></select></div></div><div class="flex-item"><div class="select-field"><select id="years" class="browser-default ng-untouched ng-pristine ng-invalid"><option selected="" value="" disabled="">Yıl</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option><option value="1949">1949</option><option value="1948">1948</option><option value="1947">1947</option><option value="1946">1946</option><option value="1945">1945</option><option value="1944">1944</option><option value="1943">1943</option><option value="1942">1942</option><option value="1941">1941</option><option value="1940">1940</option><option value="1939">1939</option><option value="1938">1938</option><option value="1937">1937</option><option value="1936">1936</option><option value="1935">1935</option><option value="1934">1934</option><option value="1933">1933</option><option value="1932">1932</option><option value="1931">1931</option><option value="1930">1930</option><option value="1929">1929</option><option value="1928">1928</option><option value="1927">1927</option><option value="1926">1926</option><option value="1925">1925</option><option value="1924">1924</option><!----></select></div></div></div></form></birthdate-input><!----><!----><div><!----><!----></div><!----><!----><div class="cpf-number-loading"><!----><!----><!----><!----><!----><!----><!----><!----><!----></div><!----><!----><!----><!----></div><!----><!----><!----><!----><!----><!----><!----><!----><!----><div class="input-field identity required"><span class="field-label required">Kimlik</span><!----><!----><div><!----><!----></div><!----><!----><div class="cpf-number-loading"><input debounce="2000" class="validate browser-default place-text ng-untouched ng-pristine ng-invalid" id="identity" placeholder="" type="text" required=""><!----><!----><!----><!----><!----><!----><!----><!----><!----></div><!----><!----><!----><!----></div><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><div class="select-field" style="position: relative;"><!----></div><!----><div class="select-field"><!----><!----><!----><!----><!----><!----><!----><!----></div><!----><!----><!----><!----><!----><!----><!----><!----><div class="select-field" style="position: relative;"><!----></div><!----><div class="select-field"><!----><!----><!----><!----><!----><!----><!----><!----></div><!----><!----><!----><!----><!----><!----><!----><div class="three-steps-mode"><!----><!----><div class="flex-container step-btns"><!----><!----><!----><!----><!----></div><!----></div></div></div><!----></div><!----><!----><div class="col prsnl-infrmtn s4"><div class="modul-accordion"><div class="modul-header"><i class="fa fa-user right"></i><span class="left header-text">Bilgileri Onayla</span></div><div class="module-content"><div class="register-info"><span>Perabet sitesine kayıt olunurken, hesabınızın teyidi ve güvenliği için doğru kişisel bilgiler gerekir. Bunu yapmayanların hesapları dondurulur ve/veya hesap temelli olarak feshedilir. Müşteriler kendi ülkelerinin bahis oynama yasalarının getirdiği sorumlulukla hareket ederler. Perabet açıklama yapmadan herhangi bir üyeliği reddetme hakkına sahiptir.</span></div><!----><!----><!----><!----><!----><!----><!----><!----><div class="checkbox-field mar-top-10"><input type="checkbox" class="filled-in ng-untouched ng-pristine ng-invalid" name="termsAndConditions" id="termsAndConditions" required=""><label for="termsAndConditions"><span class="required-icon"></span><!----> Yukarıda verdiğim bilgilerin doğru olduğunu teyit ederim. Ayrıca tüm kuralları, şartları, koşulları, politikaları ve ilgili diğer site kuralları okuduğumu ve kabul ettiğimi onaylıyorum. <a class="blue-text termsAndConditions">şartlar ve koşullar. </a><!----><!----><!----><!----></label><!----></div><!----><!----><!----><!----><div class="three-steps-mode"><!----><!----><div class="flex-container step-btns"><!----><!----><button type="submit" class="btn next-btn flex-item register-btn"> Üye Ol </button><!----><!----><!----></div><!----></div></div></div><app-static-inner-content contentcode="signupRightBottom"><!----></app-static-inner-content><!----><!----></div><!----><!----><!----></div><!----></form><!---->
                     </div>
                  </div>
                  <div class="row">
                     <div class="col s12">
            ...
            <!----><!----><!---->
            <div id="termsAndConditionsModal" materialize="modal" class="modal" style="z-index: 1093;">
               <div class="mdl-hdr">
            ...
            <div id="checkOurTermsAndConditionsModal" materialize="modal" class="modal pad-10 signup-check-modal" style="z-index: 1095;">
            ...
            <div id="privacyPolicyModal" materialize="modal" class="modal" style="z-index: 1097;">
               <div class="mdl-hdr">
                  <div class="header-content">
                     <div class="modal-close-button"><a><i class="fa fa-times"></i></a></div>
                  </div>
