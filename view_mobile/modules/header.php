            ...
            <div id=allCnt>
               ...
               <app-bottom-menu>
                  <div class=bottom-fixed-controls>
                     <div class="bottom-fixed-wrapper flex-container"><a routerlinkactive=active href=/casino class="flex-item truncate" id=undefined><i class="icon foot-icon cherry"></i> Casino </a><a routerlinkactive=active href=/livecasino class="flex-item truncate" id=undefined><i class="icon foot-icon cards-fill"></i> Canlı Casino </a><a href=javascript:void(0) class="button-collapse right-sidebar coupon" id=bslpb><i aria-hidden=true class="fa fa-plus"></i></a><a routerlinkactive=active href=/live class="flex-item truncate" id=undefined><i class="material-icons foot-icon">ondemand_video</i> Canlı Bahis </a><a target="_blank'" class="flex-item truncate" id=lc-c href=# onclick="maximizeTawkToWidget()"><i class="material-icons foot-icon">mode_comment</i> Destek </a></div>
                  </div>
